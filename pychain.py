...
sender = st.text_input("Input Sender Info")

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
receiver = st.text_input("Input Receiver Info")
...
difficulty = st.sidebar.slider("Block Difficulty", 1, 10, 2)
pychain.difficulty = difficulty

st.sidebar.write("# Block Inspector")
selected_block = st.sidebar.selectbox(
    "What block would you like to see?", pychain.chain
)
